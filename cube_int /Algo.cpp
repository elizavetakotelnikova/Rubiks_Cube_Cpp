...
bool::Algo::First_layer_solved(Cube& Cube){
    COLOR_cube current_cube = Cube.getCube();
...
void::Algo::First_layer_solver(Cube &Cube) {
    COLOR_cube current_cube = Cube.getCube();
    while (!First_layer_solved(Cube)) {
        //if front side is green
        if (current_cube[2][0][2] == COLOR::GREEN && current_cube[2][1][1] == COLOR::GREEN) {
            if (current_cube[0][2][2] == COLOR::ORANGE && current_cube[0][1][1] == COLOR::YELLOW) {
                if (current_cube[5][0][0] == COLOR::WHITE && current_cube[5][1][1] == COLOR::ORANGE) {
...
void::Algo::Yellow_cross_solver(Cube &Cube) {
    COLOR_cube current_cube = Cube.getCube();
...
bool::Algo::High_corners_correct_pos(Cube& Cube){
    COLOR_cube current_cube = Cube.getCube();
...
void::Algo::Corner_cubies_solver(Cube& Cube){
    ...
    //if(Max_corners_sum(Cube) == 1){
     //   Cube.Rotate(U);
    //}
    if(Max_corners_sum(Cube) == 2){
        Cube.Rotate(U);
    }
    else if(Max_corners_sum(Cube) == 3){
        Cube.Rotate(U);
        Cube.Rotate(U);
    }
    else if(Max_corners_sum(Cube) == 4){
        Cube.Rotate(U);
        Cube.Rotate(U);
        Cube.Rotate(U);
    }
    ...
    while(!High_corners_correct_pos(Cube)){
...
void::Algo::Solved_sides(Cube& Cube){
    COLOR_cube current_cube = Cube.getCube();
