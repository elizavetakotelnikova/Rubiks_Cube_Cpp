...
void Algo::SolveYellowFace(Cube &Cube) {
    ...
    if (current_cube[0][0][0] == COLOR::YELLOW && current_cube[0][0][1] == COLOR::YELLOW && current_cube[0][0][2] == COLOR::YELLOW) {
        if (current_cube[0][1][0] == COLOR::YELLOW && current_cube[0][1][1] == COLOR::YELLOW &&
            ...
            if (current_cube[0][2][1] == COLOR::YELLOW && current_cube[2][0][0] == COLOR::YELLOW && current_cube[2][0][2] == COLOR::YELLOW) { //здесь же пофиг на передние ребра?
                Cube.Rotate(R2);
                Cube.Rotate(D);
                Cube.Rotate(Rprime);
                Cube.Rotate(U2);
    ...
    if (current_cube[0][1][2] == COLOR::YELLOW && current_cube[0][2][2] == COLOR::YELLOW && current_cube[0][0][2] == COLOR::YELLOW) {
        if (current_cube[0][2][1] == COLOR::YELLOW && current_cube[0][1][1] == COLOR::YELLOW &&
            ...
            if (current_cube[0][1][0] == COLOR::YELLOW && current_cube[3][0][0] == COLOR::YELLOW && current_cube[3][0][2] == COLOR::YELLOW) { //здесь же пофиг на передние ребра?
                Cube.Rotate(F2);
                Cube.Rotate(D);
                Cube.Rotate(Fprime);
                Cube.Rotate(U2);
    ...
    if (current_cube[0][2][0] == COLOR::YELLOW && current_cube[0][2][1] == COLOR::YELLOW && current_cube[0][2][2] == COLOR::YELLOW) {
        if (current_cube[0][1][0] == COLOR::YELLOW && current_cube[0][1][1] == COLOR::YELLOW &&
            current_cube[0][1][2] == COLOR::YELLOW) {
            if (current_cube[0][0][1] == COLOR::YELLOW && current_cube[4][0][0] == COLOR::YELLOW && current_cube[4][0][2] == COLOR::YELLOW) { //здесь же пофиг на передние ребра?
                Cube.Rotate(L2);
                Cube.Rotate(D);
                Cube.Rotate(Lprime);
                Cube.Rotate(U2);
    ...
    if (current_cube[0][0][0] == COLOR::YELLOW && current_cube[0][1][0] == COLOR::YELLOW && current_cube[0][2][0] == COLOR::YELLOW) {
        if (current_cube[0][2][1] == COLOR::YELLOW && current_cube[0][1][1] == COLOR::YELLOW &&
            current_cube[0][0][1] == COLOR::YELLOW) {
            if (current_cube[0][1][2] == COLOR::YELLOW && current_cube[2][0][0] == COLOR::YELLOW && current_cube[2][0][2] == COLOR::YELLOW) { //здесь же пофиг на передние ребра?
                Cube.Rotate(B2);
                Cube.Rotate(D);
                Cube.Rotate(Bprime);
                Cube.Rotate(U2);
    ...
    //pos 3.3. check please      !!!it is okey, nastya have checked
    if (current_cube[0][0][0] == COLOR::YELLOW && current_cube[0][0][1] == COLOR::YELLOW) {
        if (current_cube[0][1][0] == COLOR::YELLOW && current_cube[0][1][1] == COLOR::YELLOW && current_cube[0][1][2] == COLOR::YELLOW) {
            if (current_cube[0][2][1] == COLOR::YELLOW && current_cube[0][2][2] == COLOR::YELLOW) {
    ...
    if (current_cube[0][0][1] == COLOR::YELLOW && current_cube[0][1][0] == COLOR::YELLOW && current_cube[0][1][1] == COLOR::YELLOW && current_cube[0][1][2] == COLOR::YELLOW && current_cube[0][2][1] == COLOR::YELLOW) {
        if (current_cube[3][0][0] == COLOR::YELLOW && current_cube[3][0][2] == COLOR::YELLOW && current_cube[5][0][0] == COLOR::YELLOW && current_cube[5][0][2] == COLOR::YELLOW) {
            Cube.Rotate(F);//ВАЖНО!!! вот у тебя тут во 2ом ифе было [4][0][0], [4][0][2], [2][0][0],[2][0][0], я поменяла, но у меня и так и так сработало
            Cube.Rotate(U2);
            Cube.Rotate(Fprime);
            Cube.Rotate(Uprime);
            Cube.Rotate(F);
...
void::Algo::firstLayerSolver(Cube &Cube) {
    ...
    while (!isSolvedFirstLayer(Cube)) {
        ...
        /*else if (current_cube[2][0][2] == COLOR::WHITE && current_cube[0][2][2] == COLOR::GREEN && current_cube[5][0][0] == COLOR::ORANGE) {
                    Cube.Rotate(Fprime);
                    Cube.Rotate(Uprime);
                    Cube.Rotate(F);
        }*/
        ...
        /* else if (current_cube[4][0][2] == COLOR::WHITE && current_cube[0][0][0] == COLOR::BLUE && current_cube[3][0][0] == COLOR::RED) {
                     Cube.Rotate(Bprime);
                     Cube.Rotate(Uprime);
                     Cube.Rotate(B);
         }*/
        ...
        /*else if (current_cube[4][0][2] == COLOR::RED && current_cube[0][0][0] == COLOR::WHITE && current_cube[3][0][0] == COLOR::BLUE) {
                    Cube.Rotate(L);
                    Cube.Rotate(U2);////!!!fixed
                    Cube.Rotate(Lprime);
                    Cube.Rotate(Uprime);
        }*/
        ...
        /*if (current_cube[5][0][2] == COLOR::ORANGE && current_cube[0][0][2] == COLOR::BLUE && current_cube[4][0][0] == COLOR::WHITE) {
                    Cube.Rotate(B);
                    Cube.Rotate(U);
                    Cube.Rotate(Bprime);
        }*/
        ...
        /*else if (current_cube[5][0][2] == COLOR::WHITE && current_cube[0][0][2] == COLOR::ORANGE && current_cube[4][0][0] == COLOR::BLUE) {
                    Cube.Rotate(Rprime);
                    Cube.Rotate(Uprime);
                    Cube.Rotate(R);
        }*/
        if(current_cube[0][0][2] == COLOR::WHITE) {
            ...
            /* }
             else if(current_cube[5][0][2] == COLOR::ORANGE && current_cube[4][0][0] == COLOR::GREEN){
                 Cube.Rotate(R);
                 Cube.Rotate(U2);
                 Cube.Rotate(Rprime);
                 Cube.Rotate(Uprime);
             }
             else if(current_cube[5][0][2] == COLOR::GREEN && current_cube[4][0][0] == COLOR::RED){
                 Cube.Rotate(F);
                 Cube.Rotate(U2);
                 Cube.Rotate(Fprime);
                 Cube.Rotate(Uprime);
             }
             else if(current_cube[5][0][2] == COLOR::RED && current_cube[4][0][0] == COLOR::BLUE){
                 Cube.Rotate(L);
                 Cube.Rotate(U2);
                 Cube.Rotate(Lprime);
                 Cube.Rotate(Uprime);
            ...
            /*else if (current_cube[5][0][2] == COLOR::BLUE && current_cube[0][0][2] == COLOR::WHITE && current_cube[4][0][0] == COLOR::ORANGE) {
                        Cube.Rotate(B);
                        Cube.Rotate(U2);
                        Cube.Rotate(Bprime);///!!fixed
                        Cube.Rotate(Uprime);
            }*/
...
bool Algo::areCornersSolved(Cube &Cube) {
    COLOR_cube current_cube = Cube.getCube();
...
void::Algo::solveCorners(Cube& Cube){
    COLOR_cube current_cube = Cube.getCube();
    while (!areCornersSolved(Cube)) {
        ...
        else if (current_cube[4][0][1] == COLOR::RED && current_cube[3][0][1] == COLOR::ORANGE && current_cube[5][0][1] == COLOR::BLUE){
            Cube.Rotate(L);
            Cube.Rotate(Uprime);
            Cube.Rotate(L);
            Cube.Rotate(U);
        ...
        else if (current_cube[4][0][1] == COLOR::ORANGE && current_cube[5][0][1] == COLOR::RED && current_cube[3][0][1] == COLOR::BLUE){
            Cube.Rotate(L2);
            Cube.Rotate(U);
            Cube.Rotate(L);
            Cube.Rotate(U);
